...
def interpolerA(e,a):
    ...
    e : liste d'epaisseur'
        .
    a : liste d'angle de pente de base'
        .

    Returns
    -------
    l : liste
        liste des même angles pour les épaisseurs interpollées.
...
def epaisseur_fact(n,alpha):
    ...
    Returns
    -------
    formule donné par la biblio, multiplié par l'épaisseur elle renvoie l'épaisseur corrigé
        .
...
def multiplication_par_epaisseur(n,e,a):
    ...
    Parameters
    ----------
    n : n=3 dans la  biblio
        .
    e : liste d'épaisseur interpollé'
        .
    a : liste d'angle interpollé'
        .
...
def prise_en_compte_de_la_pente(e,a):                                      
    ef=[]
